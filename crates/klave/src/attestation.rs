    ...
    fn default() -> Self {
        Quote3 {
            ...
            report_body: ReportBody {
                ...
                reserved1: vec![],
                isv_ext_prod_id: vec![],
                attributes: QuoteAttributes { flags: 0, xfrm: 0 },
                mr_enclave: crate::crypto::random::get_random_bytes(size_of::<[u8; 32]>() as i32).unwrap_or_default(),
                reserved2: vec![],
                mr_signer: crate::crypto::random::get_random_bytes(size_of::<[u8; 32]>() as i32).unwrap_or_default(),
                reserved3: vec![],
                config_id: vec![],
                isv_prod_id: 0,
                isv_svn: 0,
...
impl Default for Quote4 {
    fn default() -> Self {
        Quote4 {
            ...
            report_body: Report2Body {
                tee_tcb_svn: vec![],
                mr_seam: vec![],
                mr_signer_seam: crate::crypto::random::get_random_bytes(size_of::<[u8; 32]>() as i32).unwrap_or_default(),
                seam_attributes: vec![],
                td_attributes: vec![],
                xfam: vec![],
                mr_td: crate::crypto::random::get_random_bytes(size_of::<[u8; 32]>() as i32).unwrap_or_default(),
                mr_config_id: vec![],
                mr_owner: vec![],
                mr_owner_config: vec![],
                rt_mr: vec![],
