...
pub mod klave {
    pub mod sdk {
        ...
        pub mod sdk {
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// RATLS
            pub fn ratls_query(request: &str) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            pub fn graph_save_component(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "graph-save-component"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            pub fn inference_get_messages(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-get-messages"]
                        fn wit_import2(_: *mut u8, _: usize, _: i32, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(
                    ...
                    unsafe {
                        wit_import2(ptr0.cast_mut(), len0, _rt::as_i32(&role), ptr1)
                    };
                    let l3 = i32::from(*ptr1.add(0).cast::<u8>());
                    let result10 = match l3 {
                        0 => {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_get_parameters(
                context_name: &str,
            ) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-get-parameters"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_get_cumulative_usage_metrics(
                context_name: &str,
            ) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-get-cumulative-usage-metrics"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_get_usage_metrics_history(
                context_name: &str,
            ) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-get-usage-metrics-history"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_get_embeddings(
                context_name: &str,
                inputs_json: &str,
            ) -> Result<_rt::String, _rt::String> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-get-embeddings"]
                        fn wit_import3(
                            _: *mut u8,
                            _: usize,
                            _: *mut u8,
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// Tool management for Secret Llama
            pub fn inference_add_tool(
                context_name: &str,
                name: &str,
                description: &str,
            ...
            pub fn inference_remove_tool(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-remove-tool"]
                        fn wit_import3(
                            _: *mut u8,
                            _: usize,
                            _: *mut u8,
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_clear_tools(context_name: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-clear-tools"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            pub fn inference_list_tools(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-list-tools"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn inference_set_tool_choice(
                context_name: &str,
                choice_type: &str,
                function_name: &str,
            ) -> Result<(), _rt::String> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "klave:sdk/sdk")]
                    unsafe extern "C" {
                        #[link_name = "inference-set-tool-choice"]
                        fn wit_import4(
                            _: *mut u8,
                            _: usize,
                            _: *mut u8,
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 3817] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe9\x1c\x01A\x02\x01\
A\x02\x01B\x92\x01\x01@\x01\x0aquery-names\x01\0\x04\0\x0eadd-user-query\x01\0\x01\
...
\x07requests\0\x03\x04\0\x0bhttps-query\x01'\x04\0\x0bratls-query\x01'\x01@\x03\x0c\
service-names\x0dfunction-names\x04argss\0\x03\x04\0\x0ccall-service\x01(\x01@\x01\
\x09challenge\x05\0\x06\x04\0\x09get-quote\x01)\x01@\x02\x0ccurrent-timex\x0cquo\
te-binary\x05\0\x03\x04\0\x0cverify-quote\x01*\x01@\x01\x05quote\x05\0\x03\x04\0\
\x0bparse-quote\x01+\x01@\x01\x03uris\0\x03\x04\0\x0fconnection-open\x01,\x01@\x02\
\x0aconnections\x05querys\0\x03\x04\0\x09sql-query\x01-\x01@\x02\x0aconnections\x07\
commands\0\x03\x04\0\x08sql-exec\x01.\x01@\0\0\x03\x04\0\x0cgraph-models\x01/\x04\
\0\x10graph-tokenizers\x01/\x01@\x01\x0ecomponent-jsons\0\x08\x04\0\x14graph-sav\
e-component\x010\x01@\x01\x0amodel-names\0\x08\x04\0\x12graph-load-by-name\x011\x04\
\0\x14graph-unload-by-name\x011\x01@\x01\x0ainput-jsons\0\x08\x04\0\x1cgraph-ini\
t-execution-context\x012\x01@\x01\x0ccontext-names\0\x08\x04\0\x1egraph-delete-e\
xecution-context\x013\x01@\0\0\x08\x04\0#graph-delete-all-execution-contexts\x01\
4\x01@\x01\x0amodel-names\0\x03\x04\0\x12graph-model-n-embd\x015\x01@\x02\x0ccon\
text-names\x0buser-prompts\0\x08\x04\0\x14inference-add-prompt\x016\x01@\x03\x0c\
context-names\x0buser-prompts\x0fframe-bytes-b64s\0\x08\x04\0\x13inference-add-f\
rame\x017\x01@\x01\x0ccontext-names\0\x03\x04\0\x13inference-get-piece\x018\x01@\
\x02\x0ccontext-names\x09nb-piecesz\0\x03\x04\0\x14inference-get-pieces\x019\x01\
@\x02\x0ccontext-names\x04rolez\0\x03\x04\0\x16inference-get-messages\x01:\x04\0\
\x18inference-get-parameters\x018\x04\0&inference-get-cumulative-usage-metrics\x01\
8\x04\0#inference-get-usage-metrics-history\x018\x04\0\x16inference-model-n-embd\
\x018\x01@\x02\x0ccontext-names\x0binputs-jsons\0\x03\x04\0\x18inference-get-emb\
eddings\x01;\x01@\x03\x0ccontext-names\x0bwindow-sizez\x08agg-rulez\0\x06\x04\0\"\
inference-get-aggregate-embeddings\x01<\x01@\x02\x0ccontext-names\x06prompt\x05\0\
\x06\x04\0\x10inference-encode\x01=\x01@\x02\x0ccontext-names\x09token-ids\x05\0\
\x06\x04\0\x10inference-decode\x01>\x01@\x02\x0ccontext-names\x09token-ids\x05\0\
\x08\x04\0\x10inference-ingest\x01?\x01@\x04\x0ccontext-names\x04names\x0bdescri\
ptions\x11parameters-schemas\0\x08\x04\0\x12inference-add-tool\x01@\x01@\x02\x0c\
context-names\x04names\0\x08\x04\0\x15inference-remove-tool\x01A\x04\0\x15infere\
nce-clear-tools\x013\x04\0\x14inference-list-tools\x018\x01@\x03\x0ccontext-name\
s\x0bchoice-types\x0dfunction-names\0\x08\x04\0\x19inference-set-tool-choice\x01\
B\x01@\0\x01\0\x04\0\x0fstart-recording\x01C\x04\0\x0estop-recording\x01C\x04\0\x12\
cancel-transaction\x01C\x03\0\x0dklave:sdk/sdk\x05\0\x04\0\x1dcomponent:klave-sd\
k/klave-sdk\x04\0\x0b\x0f\x01\0\x09klave-sdk\x03\0\0\0G\x09producers\x01\x0cproc\
